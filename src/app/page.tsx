...
export default function Home() {
    ...
    return (
        <div className="grid grid-rows-[auto_1fr] lg:grid-rows-[auto_auto_auto] min-h-screen px-6 pb-10 gap-16 sm:p-20 md:p-10 lg:flex max-w-screen-xl mx-auto lg:transition-all lg:ease-in">
            ...
            <main className="flex flex-col gap-8 row-start-2 lg:w-[60%] lg:overflow-y-auto lg:pb-24">
                ...
                <section id='projects' className='space-y-8'>
                    ...
                    <Project
                        title='Hillva Honey'
                        href='https://hillvaandrea.com'
                        description='Raw honey brand from the Highlands of Rukiga, in western Uganda. Formed by an association of local beekeepers.'
                        thumbnail='/hillvaandrea.png'
                    />
